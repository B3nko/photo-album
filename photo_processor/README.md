...
This is a sample template for photo_processor - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name photo_processor --tail
```
...
```bash
aws cloudformation delete-stack --stack-name photo_processor
```
